...
const SetupAccount = ({ data }) => {
  return (
    <Card className="transaction-card">
      ...
      <DescItem label="Setter Address" style={{ display: 'none' }} value={data.NodeAddress} textClassName="monospace-text" />
      <DescItem label="Recipient Address" style={{ display: 'none' }} value={data.AccountAddress} textClassName="monospace-text" />
